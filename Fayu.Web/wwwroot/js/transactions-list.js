  ...
  $('#transactionsTable').DataTable({
    ...
    buttons: [
      ...
      },
      {
        ...
        text: '<i class="mdi mdi-plus me-0 me-sm-1"></i><span class="d-none d-md-inline-block">Add Transaction</span>',
      ...
      details: {
        display: $.fn.dataTable.Responsive.display.modal({
          header: function (row) {
            var data = row.data();
            var $content = $(data[2]);
            // Extract the value of data-transactions-name attribute (Transactions Name)
            var transactionsName = $content.find('[class^="transactions-name-full-"]').text();
            return 'Details of ' + transactionsName;
          }
        }),
        type: 'column',
